...
let sketch = s => {
    ...
    s.setup = () => {
        ...
        s.createCanvas(container.clientWidth, Math.round(10 * container.clientWidth / 16));
    ...
    s.draw = () => {
        ...
        s.fill(255);
        s.rectMode(s.CENTER);
        s.rect(s.width / 4, s.height / 2, chXStep * 15, lineHeight * 4);
        s.fill(0);
        s.textAlign(s.CENTER, s.CENTER);
        s.textFont(chFont);
        s.textSize(fontSizeCh * 2)
        s.text(comingCh, s.width / 4, s.height / 2);

        s.fill(255);
        s.rectMode(s.CENTER);
        s.rect(s.width * 3 / 4, s.height / 2, chXStep * 15, lineHeight * 4);
        s.fill(0);
        s.textAlign(s.CENTER, s.CENTER);
        s.textFont(enFont);
        s.textSize(fontSizeEn * 2)
        s.text(comingEn, s.width * 3 / 4, s.height / 2);
